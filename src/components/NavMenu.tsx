...
export default function NavMenu({name}:NavMenuProps) {
  ...
  const logout = () => {
    localStorage.removeItem('AUTH_TOKEN')  // Elimina el local storage
    queryClient.invalidateQueries({queryKey: ['user']}) // Hace un Queryinvalite de auth del archivo de hooks/useAuth.ts
  }
