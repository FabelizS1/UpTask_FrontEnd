...
export default function DashboardView() {
  ...
  const {mutate} = useMutation({
    ...
    onSuccess: (data) => {
      toast.success(data)
      queryClient.invalidateQueries({ queryKey: ['projects']})  // Forzar la actualizacion
    }
  })
...
/*
                      ...
                      <Menu as="div" className="relative flex-none">   Esto para crear el menu
