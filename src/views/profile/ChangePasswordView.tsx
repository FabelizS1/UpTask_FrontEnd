...
export default function ChangePasswordView() {
  const initialValues : UpdateCurrentUserPasswordForm = {  // Donde UpdateCurrentUserPasswordForm es el tipo de dato
    current_password: '',
    password: '',
        ...
        >
          ...
          <div className="mb-5 space-y-3">
            ...
            {...register("password_confirmation", {
                required: "El Nuevo Password Confirmation es obligatorio",
                minLength: {
                  value: 8,
                  message: 'El Password Confirmation debe ser mínimo de 8 caracteres'
                }
              })}
              />
